...
#define   ppFoundStartHeader(tag)   tag.charAt(0) == "h" && !isNaN(Number(tag.charAt(1)))
#define   ppFoundEndHeader(tag)     tag.substr(0,2) == "/h" && tag.length == 3
#define   ppFoundStartP(tag)        tag.substr(0,1) == "p" && tag.length == 1
#define   ppFoundEndP(tag)          tag.substr(0,2) == "/p"
